        ...
        <div className="container ">
            ...
            <div className="accordion" id="accordionExample">
                <div className="accordion-item">
                    ...
                    Textutils gives you a way to analyze your text quickly and efficiently. Be it word count, character count any many more 
            ...
            <div className="about-us-section container my-2">
        <div className="row">
